...
![Pavu Control](static/images/audio/pavu_audio_1.png)
...
![Playback Tab](static/images/audio/pavu_audio_3.png)


Similarly, the "Recording" tab will show a list of applications that are currently recording audio.

![Recording Tab](static/images/audio/pavu_audio_4.png)
...
![Output Devices Tab](static/images/audio/pavu_audio_5.png)

The "Input Devices" tab shows a similar list for input devices.

![Input Devices Tab](static/images/audio/pavu_audio_6.png)

Under "Configuration," each sound card should be listed.

![Configuration Tab](static/images/audio/pavu_audio_7.png)
...
![AlsaMixer](static/images/audio/alsa_audio_4.png)
...
![AlsaMixer_1](static/images/audio/alsa_audio_5.png)
