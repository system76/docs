...
- [i-tec USB 3.0/USB-C Dual HDMI Docking Station](https://i-tec.pro/en/produkt/u3dualhdmidock-2/) [community-tested on an Intel system]
  - Video and USB keyboard input lags when only external HDMI monitor connected to dock is in use (with laptop lid closed or laptop display disabled).
  - Works as expected when laptop display is enabled or HDMI is connected directly to laptop port.
