...
To open the `Launcher` press the <kbd>SUPER</kbd> key. or click the launcher icon in the Dock.
...
To learn more about the Pop!_Shop refer to [this page](/articles/pop-shop/), and for more information about package management in Pop!\_OS see this [article](/articles/manage-repos-pop/).
