...
>**Note:** Do not choose any install or repair options, as this could result in data loss. If you have accessed any filesystems and intend to install or refresh afterwards, the machine should be rebooted into a fresh recovery environment to clear any created mount points.
