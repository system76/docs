...
|Pop!_OS 20.10 (groovy) |Refresh the OS from a recently upgraded [recovery partition](#pop-recovery), or perform a clean install using a [Live USB](#pop-live-os) containing the latest release|
