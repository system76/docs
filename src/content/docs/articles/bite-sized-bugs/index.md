...
![Bitesize Bugs](img/bsb-github-screenshot.png)
...
![Your Very Own Fork](img/my-very-own-fork.png)
...
![Clone your repo](img/clone-me.png)
...
![Cloning the repo](img/git-clone.png)
...
![Palette Settings](img/palette-line.png)

I'll change the proper setting in here (took some RGB brushing up to figure out which one was the right one).

Before:
![Before Palette Setting](img/before.png)

After:
![After Palette Setting](img/after.png)
...
![Commit Made](img/commit-sent.png)
...
![Push Successful](img/push-successful.png)
...
![Ahead of Master](img/branch-ahead.png)
