...
![Keyboard Shortcuts dialog](img/shortcuts.png)
...
![Removing an existing shortcut](img/remove-existing.png)
...
![New shortcut entry](img/shortcut-entry.png)
...
![Custom Shortcuts category](img/custom-shortcuts.png)

Click the `Add Shortcut` button.

![Custom Shortcuts list](img/custom-shortcuts-list.png)

Enter a name for the shortcut, the application or command to launch, and the key combination, then click `Add`.

![Adding a custom shortcut](img/add-custom-shortcut.png)
