...
- On older System76 products, the Super key is represented by the Ubuntu logo (<kbd><Icon name="fa6-brands:ubuntu" /></kbd>).
...
| Shortcut                                                                | Action                                   |
| ----------------------------------------------------------------------- | ---------------------------------------- |
| <kbd>SUPER</kbd> + <kbd>Direction keys</kbd>                      | Navigate between windows                 |
