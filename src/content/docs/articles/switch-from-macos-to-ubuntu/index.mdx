...
Ubuntu has a [Dash](https://help.gnome.org/misc/release-notes/3.6/users-activities-overview.html.en) much like Apple's [Spotlight](https://support.apple.com/en-us/HT204014) search. If you press the Super key <kbd><Icon name="fa6-brands:ubuntu" /></kbd> all graphical software and files can be searched for easily.
