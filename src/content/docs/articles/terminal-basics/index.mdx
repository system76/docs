...
To open a <u>Terminal</u>, tap the Super Key <kbd><Icon name="fa6-brands:ubuntu" /></kbd>, <kbd><Icon name="simple-icons:popos" /></kbd> to search your computer and type the word <u>Terminal</u>.
