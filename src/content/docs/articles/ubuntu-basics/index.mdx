...
This screen can also be accessed by pressing <kbd><Icon name="fa6-brands:ubuntu" /></kbd> + <kbd>A</kbd>, <kbd><Icon name="simple-icons:popos" /></kbd> + <kbd>A</kbd> or <kbd>Super</kbd> + <kbd>A</kbd>.
