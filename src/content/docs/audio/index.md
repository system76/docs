...
![COSMIC Launcher](img/COSMIC-Launcher.jpg)

![COSMIC Launcher search for Sound](img/COSMIC-Launcher-Sound.jpg)

On the Sound page of Settings, the selected Input and Output Device will be displayed:

![Sound Settings](img/COSMIC-Sound-Settings.png)
...
![PulseAudio Volume Control shown in the COSMIC Store](img/COSMIC-pavucontrol.png)
...
![Playback tab in PulseAudio Volume Control](img/COSMIC-pavucontrol-playback.png)

Similarly, the "Recording" tab will show a list of applications that are currently recording audio.

![Recording tab in PulseAudio Volume Control](img/COSMIC-pavucontrol-recording.png)
...
![Output devices tab in PulseAudio Volume Control](img/COSMIC-pavucontrol-output.png)

The "Input Devices" tab shows a similar list for input devices.

![Input devices tab in PulseAudio Volume Control](img/COSMIC-pavucontrol-input.png)

Under "Configuration," each sound card should be listed.

![Configuration tab in PulseAudio Volume Control](img/COSMIC-pavucontrol-configuration.png)
...
![ALSAMixer](img/COSMIC-ALSAmixer.png)
...
![ALSAMixer select soundcard](img/COSMIC-ALSAmixer-soundcard.png)
...
![ALSA-info](img/COSMIC-ALSA-info.png)
