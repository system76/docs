...
Pop!_OS : <kbd><Icon name="simple-icons:popos" /></kbd> + <kbd>T</kbd>
...
This will cause the forward and back mouse button to emulate pressing the <kbd>Ctrl</kbd>+<kbd><Icon name="simple-icons:popos" /></kbd>+<kbd>Up</kbd> and <kbd>Down</kbd>. This is useful for switching workspaces very quickly while leaving your hand on the mouse.
