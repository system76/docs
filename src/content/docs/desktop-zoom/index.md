...
![Pop OS Display Settings with Fractional scaling highlighted](img/settingsdisplayshighlighted.png)
...
![Keep Settings Option](img/settings150percent.png)
...
![Pop OS Accessibility Settings Zoom option](img/accessibilityzoom.png)

4. Adjust your magnification settings in increments. 2.0 is a good starting point
5. Select 'Follow Mouse cursor'

![Pop OS Accessibility Settings Zoom options](img/accessibilityzoomsettings.png)
