...
![General look of desktop](img/pop-desktop-screenshot.png)
...
![Installer Images: Download screen](img/Installer-Screenshot.png)
...
![Intel/AMD + NVIDIA](img/intel-nvidia-rpi.png)
...
![Encryption, in-progress screen](img/Encryption-Screenshot.png)
...
![Pop Shop](img/pop-shop-screenshot.png)
...
![Power Profiles/Graphics toggle](img/system-menu.png)
