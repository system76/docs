...
The USB drive used to flash the firmware, must be formatted to the FAT32 filesystem. If you need to reformat your flash drive as FAT32, please refer to our [Format Your Drive](../format-drive/index.md) support article.
...
Press the <kbd><Icon name="simple-icons:popos" /></kbd>/<kbd><Icon name="fa6-brands:ubuntu" /></kbd> key then type 'usb' to launch the Popsicle application.
...
Press the <kbd><Icon name="simple-icons:popos" /></kbd>/<kbd><Icon name="fa6-brands:ubuntu" /></kbd> key then type 'disks' to launch the Disks application.
