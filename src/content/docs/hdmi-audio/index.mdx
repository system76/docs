...
To make all sound play over HDMI, open the menu in the top right of the screen, then click the <Icon name="fa6-solid:gear" /> icon in the bottom left of the menu.
