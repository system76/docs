...
![VirtualBox Initial Screen](img/Virtualbox-initial.png)
...
![Name the VM](img/Create_VM_name.png)
...
![Memory Size](img/set_memory.png)
...
![Hard Disk](img/create_hard_disk.png)
...
![Select Storage Type](img/select_virtdisk_type.png)

You can accept the default value here as well and click on the "Next" button.

### 6. Set Drive Allocation Type

![Select Allocation Type](img/storage_allocation_type.png)
...
![Storage Device Name](img/disk_storage_size.png)
...
![Select the ISO image](img/select_diskfile_dialog.png)
