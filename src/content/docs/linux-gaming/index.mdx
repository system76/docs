...
Open the <u>Terminal</u> application by searching for <u>Terminal</u> after pressing the Super Key <kbd><Icon name="fa6-brands:ubuntu" /></kbd>/<kbd><Icon name="simple-icons:popos" /></kbd>/<kbd>SUPER</kbd>.
