...
If you are using Ubuntu we can boot from a live disk and [here](../live-disk/index.md) are instructions for creating the live disk. Once the live disk has been created refer to this [article](../boot-menu/index.md) for booting from the live disk.

#### Mounting the Installed OS

On Pop!\_OS press <kbd><Icon name="simple-icons:popos" /></kbd>+<kbd>T</kbd> or on Ubuntu press <kbd><Icon name="fa6-brands:ubuntu" /></kbd>+<kbd>Alt</kbd>+<kbd>T</kbd> to open a terminal, and type in these commands:
