...
Firstly, we will need a terminal. You can open it by pressing Super Key <kbd><Icon name="fa6-brands:ubuntu" /></kbd>/<kbd><Icon name="simple-icons:popos" /></kbd> on your keyboard or searching for terminal app in your application menu.
...
You can try lowering certainty level of howdy--in by editing it's configuration file. Hit the Super Key <kbd><Icon name="fa6-brands:ubuntu" /></kbd>/<kbd><Icon name="simple-icons:popos" /></kbd> and <kbd>T</kbd> to open a terminal window.
...
Open a terminal window by pressing the Super Key <kbd><Icon name="fa6-brands:ubuntu" /></kbd>/<kbd><Icon name="simple-icons:popos" /></kbd> and <kbd>T</kbd> or searching for a Terminal app in your applications menu. Type in:
