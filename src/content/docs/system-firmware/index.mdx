...
After creating the live disk, [access the boot menu](/articles/boot-menu/) and select it from the list of options. Once the desktop appears, open a terminal (<kbd><Icon name="simple-icons:popos" /></kbd> + <kbd>T</kbd>) and use this command to list the partitions on your system:
