...
To configure your touchpad, press the Super key (<kbd><Icon name="fa6-brands:ubuntu" /></kbd>/<kbd><Icon name="simple-icons:popos" /></kbd>), then type <u>Mouse & Touchpad</u> and click on the result.
