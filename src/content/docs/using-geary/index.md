...
1. Download the <u>ProtonMail Bridge</u> from [here](https://protonmail.com/bridge/).
    ...
    ![ProtonMail Bridge Step1](img/protonmail-bridge-step1.png)

    ![Download ProtonMail Bridge](img/protonmail-bridge-deb.png)

2. Install <u>Protonmail Bridge</u>

    ![Download ProtonMail Bridge2 Step2](img/protonmail-bridge-download.png)

    Once the `.deb` file has been opened by <u>Eddy</u> click the **Install** button to install the application.

    ![Install ProtonMail Bridge](img/protonmail-bridge-install.png)
...
3. Setup <u>Protonmail Bridge</u>
    ...
    ![Setup ProtonMail Bridge Step1](img/protonmail-bridge-setup1.png)
    ...
    ![Setup ProtonMail Bridge Step2](img/protonmail-bridge-setup2.png)
    ...
    ![Setup ProtonMail Bridge Step3](img/protonmail-bridge-setup3.png)
...
4. Add the account to <u>Geary</u>
    ...
    ![Geary Add Account Step1](img/geary-add-other-account.png)
    ...
    ![Geary Add Account Step2](img/geary-add-protonmail.png)
    ...
    ![Geary Add Account Step3](img/trust-window.png)
...
![icloud mail settings](img/icloud-email-settings.png)
...
3. Next create an App password using the steps on this Apple Support page: <https://support.apple.com/en-us/HT204397>
    ...
    ![Apple ID Security Page](img/apple-id-app-password.png)

    ![app password](img/gear-app-password.png)
...
5. Add the new App password, IMAP, SMTP address, and in the next <u>Geary</u> window.
    ...
    ![icloud setup](img/icloud-email-setup2.png)
